  ...
  <div class="flex flex-col justify-between h-full">
    ...
    >
      <input
        type="text"
        id="search"
        class="block w-full md:px-4 px-3 md:py-3 py-2 placeholder-gray-200 focus:outline-none sm:text-base text-sm border-gray-300 rounded "
      ...
      <div>
        ...
        >
          <ChatAltIcon class="cursor-pointer md:w-6 w-5 t" />
        </button>
      </div>
    </div>
  </div>
